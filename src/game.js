...
import {addItem,bonuses,createInventory,discardItem,equipItem,generateItem,itemIconKey,itemPower,loadInventory,lootProfile,saveInventory,sortInventory,unequipSlot} from './items.js?v=8';
